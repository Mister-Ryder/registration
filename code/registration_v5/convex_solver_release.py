...
implementation vendored in :mod:`registration_v5.inference`.
"""
...
from .inference.dns_convex_solver import (
    DNSConvexConfig,
    solve_dns_convex,
)
...
def descriptor_convex_adam_release(
    ...
    *,
    ...
    diagnostics = {
        ...
        "channel_contract": 24,
        "solver": "registration_v5.inference.dns_convex_solver.solve_dns_convex",
